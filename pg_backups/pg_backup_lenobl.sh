...
=================================================================
# Скрипт автоматического резервного копирования резервных баз данных PostgreSQL и их копирования на NFS-шару
# =================================================================
#
#
# Использование: $0 <nfs_backup_dir>
# Этот скрипт предназначен для создания резервных копий баз данных PostgreSQL и их копирования на NFS-шару.
# Также данный скрипт валидирует созданные резервные копии баз данных и пользователей
# Перед использованием убедитесь, что NFS-шара доступна на целевом сервере с помощью команды \"showmount -e <nfs-server>\"
# Аргументы:
#   <nfs_backup_dir>: Путь к NFS-шаре для размещения резервных копий.
